...
\begin{figure}[H]
\centering
\subcaptionbox{\label{fig:PTCDI-moire}}{\includegraphics[width = 4 in]{PTCDI-Moire.png}}\llap{{\raisebox{1cm}{\includegraphics[height=1.9cm]{MoS2_mapsshot.pdf}}}}\hspace{10pt}
\subcaptionbox{\label{fig:PTCDI-UPS}}{\includegraphics[scale = 1.4]{PTCDI-UPS.png}}
\subcaptionbox{\label{fig:PTCDA-moire}}{\includegraphics[width = 4 in]{PTCDA-moire.png}}\llap{{\raisebox{1cm}{\includegraphics[height=2cm]{MoS2_mapsshot.pdf}}}}\hspace{10pt}
...
\begin{figure}[H]
\centering
\subcaptionbox{\label{fig:close-packed}}{\includegraphics[scale = 0.20]{CuPc hexagon phase.png}}\hspace{0pt}
\subcaptionbox{\label{fig:row-like}}{\includegraphics[scale = 0.2]{CuPc rowlike phase.png}}
